...
export default function Login({ isAuthenticated, setIsAuthenticated }: AuthProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen gap-3 w-60">
            ...
            <Link to="/register" className="hover:underline text-stone-300">Register →</Link>
            </div>
            <div className="p-3 border rounded-lg w-68">
            <h1 className="font-bold text-stone-300">Login</h1>
